...
- Lovable project: `https://lovable.dev/projects/3067d8e5-543b-43dc-9435-5116c68b2080`
- Local prototype path: `LovableApp/scope-prototype-main`
...
- Reflete as constraints da variante indicadas nos ficheiros.
...
- Foi gerada uma app mínima de página única para demonstrar o slice `Evidence metadata capture -> validation`.
...
- Slice único `B — Evidence metadata capture -> validation`.
...
- `npm test` concluído com sucesso: `1` test file passed, `1` test passed.
