# Notas de Elicitação — Lab 2 (AMS)

## Preparação da entrevista
- Data: 2026-02-16
- Equipa cliente: AMS Transition Lead & Chief Information Security Officer (CISO)
- Equipa Dev: Team DNR
- Slice discutido: Intake & Discovery (AMS)
- Variante: 3 (Autorização estrita e ações controladas)

## Âncoras de contexto (AMS)
- Setor: Financial Services (Banking/Insurance) - requires high security and compliance.
- Tipo de solução: Custom Transition & Data Management Platform.
- Modelo de suporte (L1/L2/L3 + hours + languages): L2/L3, 24/7, English & Portuguese.
- Principais problemas da transição (resumo): Atualmente, qualquer utilizador consegue editar ou sobrescrever dados de transição. Não existe um audit trail claro de quem aprovou o Intake, e utilizadores não autorizados tentam forçar o avanço dos processos sem validação adequada.

## Perguntas e Respostas (min. 10)
...
3. [Evidência] Q: Como é que o sistema prova que um utilizador tem a role de "Security Officer" atribuída?
...
6. [Evidência] Q: Que evidência documental é necessária para provar que a equipa tem o plano de Disaster Recovery (DR) preparado?
...
9. [Evidência] Q: Quão recente tem de ser a evidência do plano de DR para ser aceite no processo de Intake?
...
- Como é que a variante alterou o foco da nossa elicitação?
